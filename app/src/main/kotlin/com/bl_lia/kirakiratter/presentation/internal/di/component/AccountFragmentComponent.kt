...
import com.bl_lia.kirakiratter.presentation.internal.di.module.ConfigModule
...
@PerFragment
@Component(dependencies = arrayOf(ApplicationComponent::class), modules = arrayOf(FragmentModule::class, AccountFragmentModule::class, StatusModule::class, ConfigModule::class))
