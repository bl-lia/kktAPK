...
@PerFragment
@Component(dependencies = arrayOf(ApplicationComponent::class), modules = arrayOf(FragmentModule::class, TimelineModule::class, StatusModule::class, ConfigModule::class))
