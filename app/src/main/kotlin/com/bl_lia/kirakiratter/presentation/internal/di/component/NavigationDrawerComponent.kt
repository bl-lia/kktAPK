...
@PerFragment
@Component(dependencies = arrayOf(ApplicationComponent::class), modules = arrayOf(FragmentModule::class, PushNotificationModule::class, AuthModule::class, ConfigModule::class))
